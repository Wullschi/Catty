...
final class AudioEngineExtraTests: XMLAbstractTest {
...
//    }
    ...
    func testStartSound() {
        do {
            ...
            let scene = self.createScene(project: project, audioEngine: soundEngine)
            try recorder.record()
...
//            } catch {}
    ...
    private func createScene(project: Project, audioEngine: AudioEngine) -> CBScene {
