...
@objc extension SpeakAndWaitBrick: CBInstructionProtocol, AVSpeechSynthesizerDelegate {
    ...
    @nonobjc func instruction() -> CBInstruction {
        ...
        return CBInstruction.waitExecClosure { (context, _) in
            ...
            usleep(10000) //will sleep for 0.01 seconds. Nötig um im Folgenden Fall ein beständiges Verhaöten zu haben: Erstes Objekt hat einen when tapped brick und dann 2 speak and wait bricks. 2. Objekt hat einen when tapped brick und einen speak and wait brick. zuerst 1. objekt, dann 2. anklicken. Speak und wait vom 2. Brick soll gar nicht abgespielt werden, da der 2. speak and wait vom 1. objekt dann gleich wieder einsetzt und den speak and wait vom 2. objekt stopt
...
//        }
        ...
        while(synthesizer.accessibilityElements!.count > 0) {
